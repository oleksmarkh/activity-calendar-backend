...
# TODO: switch from ORM tables to models (create DB tables from models metadata instead of raw SQL schema)
if __name__ == '__main__':
    ...
    try:
        with engine.connect() as connection:
            ...
            print(f"inserted {result.rowcount} records into '{activities.name}' table")
